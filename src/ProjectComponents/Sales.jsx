...
export default function Sales() {
  ...
  function tableSubmit(e) {
    ...
    //   navigate("/salesexpenses");
      ...
      axios.post("https://65d86bd0c96fbb24c1bb7cbe.mockapi.io/sales_table", postData)
        .then((res) => {
          console.log(res);
            ...
            {rows.map((rows, i) => {
              ...
              return (
                <tr>
                  ...
                  <td><td>{rows.selectproduct ? rows.selectproduct.price : ""}</td><label htmlFor=""></label></td>
