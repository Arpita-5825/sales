...
export default function Products() {
  ...
  function handleSubmit(e) {
    ...
    if (id === undefined) {
      axios.post("https://65d86bd0c96fbb24c1bb7cbe.mockapi.io/saleproject/", data)
        .then((res) => {
      ...
      axios.put("https://65d86bd0c96fbb24c1bb7cbe.mockapi.io/saleproject/" + id, data)
        .then((res) => {
          console.log(res.data);
          loadData();
          setId(undefined)
  ...
  function handleUpdate(e, id) {
    ...
    setId(id);
    axios.get("https://65d86bd0c96fbb24c1bb7cbe.mockapi.io/saleproject/" + id)
      .then((res) => {
        console.log(res.data);
        setData({
  ...
  function handleDelete(e, id) {
    e.preventDefault();
    axios.delete("https://65d86bd0c96fbb24c1bb7cbe.mockapi.io/saleproject/" + id)
      .then((res) => {
        console.log(res.data);
        loadData();
      })
  }
  //https://65d86bd0c96fbb24c1bb7cbe.mockapi.io/saleproject
